                ...
                <div className="col-lg-3 col-md-4">
                    <div className="footer-widget">
                        <Link className="nav-footer-logo" to="/">
                            ...
                            </span><h5 className="fs-2 fw-bold text-light ms-1 my-0">Unicorn</h5>
                        </Link>
                ...
                <div className="col-lg-3 col-md-4">
                    <div className="footer-widget">
                        ...
                        <ul className="footer-menu">
                            ...
                            <li><Link to="#">Feature Property</Link></li>
                            <li><Link to="#">Recent Property</Link></li>
                        </ul>
                    </div>
                </div>
            ...
            <div className="container">
                <div className="row align-items-center">
                    <div className="col-lg-6 col-md-6">
                        <p className="mb-0">© {new Date().getFullYear()} Resido. Develop with <i className="fa-solid fa-heart ms-1 text-danger"></i>  By <Link to="https://amrithaa.com/" target="_blank">Amrithaa</Link></p>
                    </div>
                    <div className="col-lg-6 col-md-6 text-right">
                        <ul className="footer-bottom-social">
                            <li><Link to="https://www.facebook.com/" target='_blank'><i className="fa-brands fa-facebook"></i></Link></li>
                            <li><Link to="https://x.com/" target='_blank'><i className="fa-brands fa-twitter"></i></Link></li>
                            <li><Link to="https://www.instagram.com/" target='_blank'><i className="fa-brands fa-instagram"></i></Link></li>
                            <li><Link to="https://www.linkedin.com/company/" target='_blank'><i className="fa-brands fa-linkedin"></i></Link></li>
                        </ul>
                    </div>
                </div>
            </div>
