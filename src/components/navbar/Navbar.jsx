          ...
          >
            <div className="nav-header" style={{ lineHeight: "0" }}>
              <Link className="nav-brand text-logo" to="/">
                <img src={navbarData.siteConfig.logo} alt={navbarData.siteConfig.logoAlt} />
                <h5 className="fs-3 fw-bold ms-1 my-0">{navbarData.siteConfig.siteName}</h5>
              </Link>
                ...
                <div className="login-form">
                  <form>
                    ...
                    <div className="form-group">
                      <button type="button" className="btn btn-lg btn-primary fw-medium full-width rounded-2">
                        LogIn
                      </button>
                    </div>
                  </form>
                  ...
                  <ul>
                    <li>
                      <Link to="#" className="btn connect-fb">
                        <TiSocialFacebook className="ti-facebook" style={{ width: "25px", height: "25px" }} />
                        Facebook
                      </Link>
                    </li>
                    <li>
                      <Link to="#" className="btn connect-google">
                        <TiSocialGooglePlus className="ti-google" style={{ width: "25px", height: "25px" }} />
                        Google+
                      </Link>
                    </li>
                  </ul>
          ...
          <div className="tab-content" id="pills-tabContent">
            <div className={`tab-pane fade ${activeTab === 1 ? "show active" : ""}`}>
              <div className="sidebar_featured_property">
                ...
                <div className="input-group">
                  <Link to="/compare-property" className="btn btn-light-primary fw-medium full-width">
                    View & Compare
                  </Link>
                </div>
              </div>
            ...
            <div className={`tab-pane fade ${activeTab === 2 ? "show active" : ""}`}>
              <div className="sidebar_featured_property">
                ...
                <div className="input-group">
                  <Link to="#" className="btn btn-light-primary fw-medium full-width">
                    View & Compare
                  </Link>
                </div>
              </div>
