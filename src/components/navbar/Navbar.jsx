              ...
              <ul className="nav-menu">
                ...
                >
                  ...
                  <ul
                    ...
                    style={{
                      display: activeMenu["home"]?.main ? "block" : "none",
                      pointerEvents: activeMenu["home"]?.main ? "auto" : "none",
                    }}
                  >
                    <li>
                    ...
                    <li>
                      <Link
                        to="/home-2"
                        className={current === "/home-2" ? "active" : ""}
                      >
                        Home Layout 2
                      </Link>
                    </li>
                    <li>
                      <Link
                        to="/home-3"
                        className={current === "/home-3" ? "active" : ""}
                      >
                        Home Layout 3
                      </Link>
                    </li>
                    <li>
                      <Link
                        to="/home-4"
                        className={current === "/home-4" ? "active" : ""}
                      >
                        Home Layout 4
                      </Link>
                    </li>
                    <li>
                      <Link
                        to="/home-5"
                        className={current === "/home-5" ? "active" : ""}
                      >
                        Home Layout 5
                      </Link>
                    </li>
                    <li>
                      <Link
                        to="/home-6"
                        className={current === "/home-6" ? "active" : ""}
                      >
                        Home Layout 6
                      </Link>
                    </li>
                    <li>
                      <Link
                        to="/home-7"
                        className={current === "/home-7" ? "active" : ""}
                      >
                        Home Layout 7
                      </Link>
                    </li>
                    <li>
                      <Link
                        to="/home-8"
                        className={current === "/home-8" ? "active" : ""}
                      >
                        Home Layout 8
                      </Link>
                    </li>
                    <li>
                      <Link
                        to="/home-9"
                        className={current === "/home-9" ? "active" : ""}
                      >
                        Home Layout 9
                      </Link>
                    </li>
                    <li>
                      <Link
                        to="/home-10"
                        className={current === "/home-10" ? "active" : ""}
                      >
                        Home Layout 10
                      </Link>
                    </li>
                    <li>
                      <Link
                        to="/home-11"
                        className={current === "/home-11" ? "active" : ""}
                      >
                        Home Layout 11
                      </Link>
                    </li>
                    <li>
                      <Link
                        to="/video"
                        className={current === "/video" ? "active" : ""}
                      >
                        Video Home
                      </Link>
                    </li>
                ...
                >
                  ...
                  <ul
                    className="nav-dropdown nav-submenu"
                    style={{
                      display: activeMenu["listing"]?.main ? "block" : "none",
                      pointerEvents: activeMenu["listing"]?.main
                        ? "auto"
                        : "none",
                    }}
                  >
                    <li
                      ...
                      onMouseEnter={() =>
                        handleMouseEnter("listing", "list-layout")
                      }
                      onMouseLeave={() =>
                        handleMouseLeave("listing", "list-layout")
                      }
                    >
                      <Link to="#">
                        List Layout
                      ...
                      <ul
                        className="nav-dropdown nav-submenu"
                        style={{
                          display: activeMenu["listing"]?.["list-layout"]
                            ? "block"
                            : "none",
                          pointerEvents: activeMenu["listing"]?.["list-layout"]
                            ? "auto"
                            : "none",
                        }}
                      >
                        <li>
                          <Link
                            to="/list-layout-one"
                            className={
                              current === "/list-layout-one" ? "active" : ""
                            }
                          >
                            List Layout Simple
                          </Link>
                        ...
                        <li>
                          <Link
                            to="/list-layout-two"
                            className={
                              current === "/list-layout-two" ? "active" : ""
                            }
                          >
                            List Layout Modern
                          </Link>
                        ...
                        <li>
                          <Link
                            to="/list-layout-three"
                            className={
                              current === "/list-layout-three" ? "active" : ""
                            }
                          >
                            List Layout Advance
                          </Link>
                        ...
                        <li>
                          <Link
                            to="/list-layout-with-map"
                            className={
                              current === "/list-layout-with-map"
                                ? "active"
                                : ""
                            }
                          >
                        ...
                        <li>
                          <Link
                            to="/list-layout-full"
                            className={
                              current === "/list-layout-full" ? "active" : ""
                            }
                          >
                            Full Width
                          </Link>
                    ...
                    <li
                      ...
                      onMouseEnter={() =>
                        handleMouseEnter("listing", "grid-layout")
                      }
                      onMouseLeave={() =>
                        handleMouseLeave("listing", "grid-layout")
                      }
                    >
                      <Link to="#">
                        Grid Layout
                      ...
                      <ul
                        className="nav-dropdown nav-submenu"
                        style={{
                          display: activeMenu["listing"]?.["grid-layout"]
                            ? "block"
                            : "none",
                          pointerEvents: activeMenu["listing"]?.["grid-layout"]
                            ? "auto"
                            : "none",
                        }}
                      >
                        <li>
                          <Link
                            ...
                            className={
                              current === "/grid-layout-with-sidebar"
                                ? "active"
                                : ""
                            }
                          >
                        ...
                        <li>
                          <Link
                            to="/classical-layout-with-sidebar"
                            className={
                              current === "/classical-layout-with-sidebar"
                                ? "active"
                                : ""
                            }
                          >
                        ...
                        <li>
                          <Link
                            to="/classical-property"
                            className={
                              current === "/classical-property" ? "active" : ""
                            }
                          >
                            Classical Full Width
                          </Link>
                        </li>
                      </ul>
                    </li>
                    <li
                      ...
                      onMouseEnter={() =>
                        handleMouseEnter("listing", "map-layout")
                      }
                      onMouseLeave={() =>
                        handleMouseLeave("listing", "map-layout")
                      }
                    >
                      <Link to="#">
                        With Map Property
                      ...
                      <ul
                        className="nav-dropdown nav-submenu"
                        style={{
                          display: activeMenu["listing"]?.["map-layout"]
                            ? "block"
                            : "none",
                          pointerEvents: activeMenu["listing"]?.["map-layout"]
                            ? "auto"
                            : "none",
                        }}
                      >
                        ...
                        <li>
                          <Link
                            to="/classical-layout-with-map"
                            className={
                              current === "/classical-layout-with-map"
                                ? "active"
                                : ""
                            }
                          >
                        ...
                        <li>
                          <Link
                            to="/half-map"
                            className={current === "/half-map" ? "active" : ""}
                          >
                            Half Map Search
                          </Link>
                        </li>
                ...
                >
                  ...
                  <ul
                    ...
                    style={{
                      ...
                      pointerEvents: activeMenu["feature"]?.main
                        ? "auto"
                        : "none",
                    }}
                  >
                    <li
                      ...
                      onMouseEnter={() =>
                        handleMouseEnter("listing", "single-property")
                      }
                      onMouseLeave={() =>
                        handleMouseLeave("listing", "single-property")
                      }
                    >
                      <Link to="#">
                        Single Property
                      ...
                      <ul
                        className="nav-dropdown nav-submenu"
                        style={{
                          display: activeMenu["listing"]?.["single-property"]
                            ? "block"
                            : "none",
                      ...
                      >
                        <li>
                          <Link
                            ...
                            className={
                              current === "/single-property-1" ? "active" : ""
                            }
                          >
                            Single Property 1
                          </Link>
                        ...
                        <li>
                          <Link
                            ...
                            className={
                              current === "/single-property-2" ? "active" : ""
                            }
                          >
                            Single Property 2
                          </Link>
                        ...
                        <li>
                          <Link
                            to="/single-property-3"
                            className={
                              current === "/single-property-3" ? "active" : ""
                            }
                          >
                            Single Property 3
                          </Link>
                        ...
                        <li>
                          <Link
                            to="/single-property-4"
                            className={
                              current === "/single-property-4" ? "active" : ""
                            }
                          >
                            Single Property 4
                          </Link>
                    ...
                    <li
                      className={
                        ["/agents", "/agent-page", "/add-agent"].includes(
                          current
                        )
                          ? "active"
                          : ""
                      ...
                      onMouseEnter={() =>
                        handleMouseEnter("listing", "agent-list")
                      }
                      onMouseLeave={() =>
                        handleMouseLeave("listing", "agent-list")
                      }
                    >
                      <Link to="#">
                        Agents
                      ...
                      <ul
                        className="nav-dropdown nav-submenu"
                        style={{
                          display: activeMenu["listing"]?.["agent-list"]
                            ? "block"
                            : "none",
                          pointerEvents: activeMenu["listing"]?.["agent-list"]
                            ? "auto"
                            : "none",
                        }}
                      >
                        <li>
                          <Link
                            to="/agents"
                            className={current === "/agents" ? "active" : ""}
                          >
                            Agents List
                          </Link>
                        </li>
                    ...
                    <li
                      className={
                        ["/agencies", "/agency-page"].includes(current)
                          ? "active"
                          : ""
                      }
                      onMouseEnter={() =>
                        handleMouseEnter("listing", "agency-list")
                      }
                      onMouseLeave={() =>
                        handleMouseLeave("listing", "agency-list")
                      }
                    >
                      <Link to="#">
                        Agencies
                      ...
                      <ul
                        className="nav-dropdown nav-submenu"
                        style={{
                          display: activeMenu["listing"]?.["agency-list"]
                            ? "block"
                            : "none",
                          pointerEvents: activeMenu["listing"]?.["agency-list"]
                            ? "auto"
                            : "none",
                        }}
                      >
                    ...
                    <li
                      ...
                      onMouseEnter={() =>
                        handleMouseEnter("listing", "account")
                      }
                      onMouseLeave={() =>
                        handleMouseLeave("listing", "account")
                      }
                    >
                      <Link to="#">
                        My Account
                      ...
                      <ul
                        className="nav-dropdown nav-submenu"
                        style={{
                          display: activeMenu["listing"]?.["account"]
                            ? "block"
                            : "none",
                          pointerEvents: activeMenu["listing"]?.["account"]
                            ? "auto"
                            : "none",
                        }}
                      >
                    ...
                    <li>
                      <Link
                        to="/compare-property"
                        className={
                          current === "/compare-property" ? "active" : ""
                        }
                      >
                        Compare Property
                      </Link>
                    ...
                    <li>
                      <Link
                        to="/submit-property"
                        className={
                          current === "/submit-property" ? "active" : ""
                        }
                      >
                        Submit Property
                      </Link>
                ...
                >
                  ...
                  <ul
                    ...
                    style={{
                      ...
                      pointerEvents: activeMenu["pages"]?.main
                        ? "auto"
                        : "none",
                    }}
                  >
                    ...
                    <li>
                      <Link
                        to="/blog-detail"
                        className={current === "/blog-detail" ? "active" : ""}
                      >
                        Blog Detail
                      </Link>
                    </li>
                    <li>
                      <Link
                        to="/component"
                        className={current === "/component" ? "active" : ""}
                      >
                        Shortcodes
                      </Link>
                    </li>
              ...
              <ul className="nav-menu nav-menu-social align-to-right d-none d-lg-inline-flex">
                ...
                <li className="add-listing">
                  <Link to="/submit-property" className="bg-primary">
                    <img src={loginImg} alt="" className="me-1" />
                    Post Property
                  </Link>
                </li>
                <li>
                  ...
                  return (
                    <div className="sides_list_property p-2" key={index}>
                      ...
                      <div className="sides_list_property_detail">
                        <h4>
                          <Link to="/single-property-1">{item.title}</Link>
                        </h4>
