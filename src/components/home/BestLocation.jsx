            ...
            return(
                <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6" key={index}>
                    <div className="location-property-wrap rounded-4 p-2">
                        <div className="location-property-thumb rounded-4  overflow-hidden" style={{ maxHeight: '300px' }}>
                            <Link to="/listings-list-with-sidebar">
                            <img src={item.image} className="img-fluid w-100 h-100 object-fit-cover" alt="" /></Link>
                        </div>
